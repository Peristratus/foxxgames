...
APT-PAR-10.0 | PAR-10.0         | Parallax Effect                         | APT-PAR-10.0: Parallax Effect | The parallax should be functional, once user scrolls up and down the web page, the image in the middle between the top and bottom of the page should be visable .                                                                                                                                     |                     Pass                                      |
