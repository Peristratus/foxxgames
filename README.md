...
APT-CUB-6.0  | CUB-6.0          | Contact us form                     | APT-CUB-6.0.1:Click the Contact us Btn| The button should be functional and trigger the modal contact form to pop up , accept the user details and validate their inputs.                                                                                                                                          |                     Pass                                      |
