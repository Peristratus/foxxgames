...
APT-LR-7.0  | LR-7.0            | Login/Register Button               | APT-RB-7.0.1: Click on the Reset button | The button should be functional, and display the login and register page for the user to insert their details or login using social media networks.                                                                                                                                                              |                     Pass                                      |
